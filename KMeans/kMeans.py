...
prototype_List.append(prototype([0,5]))
prototype_List.append(prototype([0,4]))
...
while True :
	...
	if abs(squareError == previous_SqrErr):
		break

	data_writer(centre_List_copy,"",os.path.join(directory,outputFileName_Proto))
